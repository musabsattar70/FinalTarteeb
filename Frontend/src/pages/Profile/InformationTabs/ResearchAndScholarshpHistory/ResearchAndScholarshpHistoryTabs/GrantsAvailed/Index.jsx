...
export const GrantsAvailed = () => {
  ...
  const fetchGrantsList = async () => {
    ...
    const response = await fetch(
      import.meta.env.VITE_API_URL + "/api/grants-availed/" + id
    );
  ...
  const handleAddGrant = async () => {
    ...
    const response = await fetch(
      import.meta.env.VITE_API_URL + "/api/grants-availed/",
      {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (index) => {
    ...
    const response = await fetch(
      import.meta.env.VITE_API_URL + "/api/grants-availed/" + index,
      {
        method: "DELETE",
      }
    );
