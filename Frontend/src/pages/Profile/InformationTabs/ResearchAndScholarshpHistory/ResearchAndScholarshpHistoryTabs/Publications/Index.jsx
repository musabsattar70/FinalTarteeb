...
export const Publications = () => {
    ...
    const fetchPublicationList = async () => {
        ...
        const response = await fetch(
            `http://localhost:7075/api/publication/${id}`
        );
    ...
    const addPublication = async () => {
        // Fetch data from the server
        const response = await fetch(`http://localhost:7075/api/publication/`, {
            method: "POST",
            headers: {
            ...
            body: JSON.stringify({
                ...
                publicationName:
                    document.getElementById("publication_name").value,
                publicationLink:
                    document.getElementById("publication_link").value,
                publicationDate:
    ...
    const handleDelete = async (index) => {
        ...
        const response = await fetch(
            `http://localhost:7075/api/publication/${index}`,
            {
                method: "DELETE",
            }
        );
                ...
                <div className="personal_details_edit_wrapper">
                    {selectedPublication ? (
                        <>
                            ...
                            <button
                                onClick={selectedPublication?.true ? addPublication : handleUpdatePublicationDetails}
                                className="personal_details_edit"
                            >
