...
export const ClubPatronage = () => {
  ...
  const fetchClubPatronage = async () => {
    const response = await fetch(
      import.meta.env.VITE_API_URL + "/api/club-patronage/" + id
    );
  ...
  const handleAddStaffAppointment = async () => {
    ...
    const response = await fetch(
      import.meta.env.VITE_API_URL + "/api/club-patronage/",
      {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (index) => {
    const response = await fetch(
      import.meta.env.VITE_API_URL + "/api/club-patronage/" + index,
      {
        method: "DELETE",
      }
    );
