...
export const StaffAppointments = () => {
    ...
    const fetchStaffAppointments = async () => {
        const response = await fetch(
            "http://localhost:7075/api/staff-appointment/" + id
        );
    ...
    const handleAddStaffAppointment = async () => {
        ...
        const response = await fetch(
            "http://localhost:7075/api/staff-appointment/",
            {
                method: "POST",
                headers: {
    ...
    const handleUpdateStaffAppointmentDetails = async () => {
        ...
        const response = await fetch(
            "http://localhost:7075/api/staff-appointment/",
            {
                ...
                body: JSON.stringify({
                    staffAppointmentId:
                        selectedStaffAppointment.StaffAppointmentId,
                    designation: staffAppointmentDesignation,
                    termFrom: termFromState,
                    termTo: termToState,
                }),
    ...
    const handleDelete = async (index) => {
        const response = await fetch(
            "http://localhost:7075/api/staff-appointment/" + index,
            {
                method: "DELETE",
            }
        );
