...
export const CommunityService = () => {
  ...
  const fetchServiceList = async () => {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_API_URL}/api/community-service/${id}`
    );
  ...
  const addService = async () => {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_API_URL}/api/community-service/`,
      {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (index) => {
    const response = await fetch(
      `${import.meta.env.VITE_API_URL}/api/community-service/${index}`,
      {
        method: "DELETE",
      }
    );
  ...
  return (
    <div>
      <div>
        ...
        {selectedService && <ServiceEdit serviceDetails={selectedService} />}
