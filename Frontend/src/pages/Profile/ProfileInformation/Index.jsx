        ...
        <div className="profile_information">
            ...
            <div className="profile_information_details">
                ...
                <span>
                    Joining Date:{" "}
                    <b>
                        {instructorProfileInformation.JoiningDate?.slice(0, 10)}
                    </b>
                </span>
                <span>
                    Onboard Status:{" "}
                    <b>{instructorProfileInformation.FacultyType}</b>
                </span>
            </div>
            <button
                onClick={() => {
            ...
            {modalStatus && (
                <DownloadReportModal setModalStatus={setModalStatus} />
            )}
        </div>
    );
};
