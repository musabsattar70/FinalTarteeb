...
export const InstructorsList = ({selectedInstructors, setSelectedInstructors}) => {
        ...
        const fetchData = async () => {
            try {
                const response = await fetch(
                    "http://localhost:7075/api/reports/GetInstructorsList"
                );
    ...
    function createSchoolFormat(school, departments) {
        ...
        departments.forEach((department) => {
            const instructors = data.filter(
                (item) =>
                    item.School === school && item.Department === department
            );
    ...
    return (
        <section className="GenerateReportsChooseInstructors">
            ...
            {insturctors.map((school) => (
                <div
                    className="ChooseInstructorsSchoolContainer"
                    key={school.School}
                >
                    <h3
                        onClick={(e) => {
                        ...
                        <span
                            ...
                            onClick={(e) => {
                                if (
                                    ...
                                    deleteAllInstructorsInSchoolInState(
                                        school.School
                                    );
                                    return;
                                }
                                setAllInstructorsInSchoolInState(school.School);
                                let currentTriangleStyle =
                                    document.getElementById(
                                        "GenerateReportsTriangleOpen_" +
                                            school.School
                                    ).style.display;
                            ...
                            >
                                ...
                                <span
                                    ...
                                    onClick={(e) => {
                                        ...
                                        setAllInstructorsInProgramInState(
                                            department.Department
                                        );
                                        let currentTriangleStyle =
                                            document.getElementById(
                                ...
                                >
                                    {areAllInstructorInProgramInState(
                                        department.Department
                                    ) ? (
                                        <span
                                            id="customClickFunctionForSchoolFilled"
